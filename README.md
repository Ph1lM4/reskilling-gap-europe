...
| [Lenses](https://reskilling.nexalps.com/lenses.html) | Six practitioner and research views (Haslauer, Klinger, Ronacher/Pontella, Weber, Andreessen) with a self-honest heat-map of where each finds support in the data, three confounders the aggregate hides, and one candidate diagnostic metric for firms |
